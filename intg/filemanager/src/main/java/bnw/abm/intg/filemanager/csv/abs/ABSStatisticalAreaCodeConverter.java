...
public class ABSStatisticalAreaCodeConverter {
	...
	/**
	 * This function loads All Australia Statistical Codes csv and creates a map of values under reference column (key) and target column (value)
	 * 
	 * @param zipWithCsv
	 ...
	 * @return A map of key value pairs representing reference column value and target column value pairs
	 * @throws IOException
	 */
	public static Map<String, String> loadCsvAndCreateMapWithAreaCode(Path zipWithCsv, String csvFileName, String referenceColumnHeader,
		...
		// Iterable<CSVRecord> records = CSVFormat.RFC4180.withFirstRowAsHeader().parse(Files.newBufferedReader(extractedCsv));
